...
<body>
	...
	<table class="bordered">
		<thead>
			...
			<tr>
				<th nowrap="nowrap">新闻编号</th>
				<th nowrap="nowrap">新闻标题</th>
				<th nowrap="nowrap">新闻内容</th>
			</tr>
		</thead>
		<tbody>
			<c:forEach var="webNews" items="${webNewsList}" varStatus="vss">
				<tr target="pid" rel="${webNews.id}" >
					<td>
						${webNews.id}
					</td>
					<td>
