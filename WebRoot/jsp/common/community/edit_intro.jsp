...
<div class="pageContent">
	...
	<form method="post"
		...
		<div class="pageFormContent nowrap" layoutH="97">
			...
			<input value="${community.community_name}" type="hidden" name="community.community_name"/>
			<input value="${community.proper_name}" type="hidden" name="community.proper_name"/>
			<input value="${community.community_img_path}" type="hidden" name="community.community_img_path"/>
			<dl>
				<dt>社团简介：</dt>
				<dd>
					<textarea class="editor" name="community.community_introduction" rows="6"
						cols="100">${community.community_introduction}</textarea>
