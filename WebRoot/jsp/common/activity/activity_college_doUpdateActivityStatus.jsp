...
<div class="pageContent">
		...
		<form method="post" action="doUpdateActivityStatus_Activity.action?navTabId=updateActivity_activity&callbackType=closeCurrent" enctype="multipart/form-data" class="pageForm required-validate" onsubmit="return iframeCallback(this,navTabAjaxDone);">
	...
	<!--  <form method="post" enctype="multipart/form-data" action="applicationActivityCollege_Activity.action?navTabId=application_activity&callbackType=closeCurrent" class="required-validate pageForm" onsubmit="return validateCallback(this, navTabAjaxDone);">
		...
		<div class="pageFormContent" layoutH="56">
			...
			<div class="unit">
				<label>审核人编号：</label>
				<input type="text" name="activity.managerId" value="${activity.managerId}" size="30" readonly="readonly" />
			</div>
			<div class="unit">
				<label>活动内容介绍：</label>
			...
			<div class="unit">
				<label>证明材料：</label>
				<img alt="证明材料" src="${activity.provePict}">
			</div>
		</div>
		<div class="formBar">
			<ul>
