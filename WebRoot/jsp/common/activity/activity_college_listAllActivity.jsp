...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="edit"
				href="readyToCheck_Application.action?ids={ids}"
				target="navTab" rel="addCusNavId" title="报名审核" warn="请选择一个活动信息"><span>查看报名人员</span></a></li>
				
				<a class="delete"
				href="readyToEnd_Activity.action?ids={ids}" 
				target="ajaxTodo" title="确定要结束吗?" rel="addCusNavId" warn="请选择一个活动信息"><span>结束活动</span></a></li>
