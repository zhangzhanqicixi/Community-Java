...
<body>
	...
	<div class="login" style="margin-top:50px;">
			...
			<div class="web_login" id="web_login">
				...
				<div class="login-box">
					...
					<div class="login_form">
						<form action="login_Login" name="loginform" accept-charset="utf-8"
		...
		<div class="qlogin" id="qlogin" style="display: none; ">
			...
			<div class="web_login">
				<form id="regUser"
					accept-charset="utf-8" action="register_User.action" method="post">
					...
					<ul class="reg_form" id="reg-ul">
						...
						<li><label for="qq" class="input-tips2">昵称：</label>
							<div class="inputOuter2">
								<input type="text"  name="nameOfUser" maxlength="10"
									class="inputstyle2" />
							</div></li>
