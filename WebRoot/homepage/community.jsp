...
<body>
	...
	<div class="inner">
		...
		<nav>
			<ul class="list-none">
				<li id="nav_10001" style='width:121px;'><a href='index.jsp'
				...
				<li id='nav_3' style='width:121px;' class='navdown'><a
					href='community.jsp' class='hover-none nav'><span>社团浏览</span></a></li>
				<li class="line"></li>
				<li id='nav_4' style='width:121px;'><a href='activity.jsp'><span>社团活动</span></a></li>
				<li class="line"></li>
	...
	<div class="sidebar inner">
		<div class="sb_nav">
			...
			<h3 class='title myCorner' data-corner='top 5px'>社团浏览</h3>
			<div class="active" id="sidebar" data-csnow="2" data-class3="0"
				data-jsok="2">
				<dl class="list-none navnow">
					<dt id='part2_4'>
						<a href='#' title='所有社团' class="zm"><span>所有社团</span></a>
					</dt>
				</dl>
				<div class="clear"></div>
			</div>
		...
		<div class="sb_box">
			...
			<div class="active" id="newslist">
				...
				<table class="table_list" width="770px">
					<tr>
						<td style="display: table-cell">
							<dt>
								<a href="community_detail.jsp" target='_self'><img
									src="images/1342431883.jpg" alt="图片关键词" title="图片关键词"
									style="width:200px; height:150px;" /></a>
							</dt>
							<dd>
								<h4>
									<a href="community_detail.jsp" target='_self' title="示例案例六">示例案例六</a>
								</h4>
							</dd>
						</td>
						<td style="display: table-cell">
							<dt>
								<a href="#1111" target='_self'><img
									src="images/1342431883.jpg" alt="图片关键词" title="图片关键词"
									style="width:200px; height:150px;" /></a>
							</dt>
							<dd>
								<h4>
									<a href="#" target='_self' title="示例案例六">示例案例六</a>
								</h4>
							</dd>
						</td>
						<td style="display: table-cell">
