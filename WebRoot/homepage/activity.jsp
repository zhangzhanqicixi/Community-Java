...
<header>
    <div class="inner">
        ...
        <nav>
            <ul class="list-none">
                <li id="nav_10001" style='width:121px;'><a href='index.jsp' class='nav'><span>网站首页</span></a>
                </li>
                <li class="line"></li>
    ...
    <div class="sb_nav">
        ...
        <div class="active" id="sidebar" data-csnow="2" data-class3="0" data-jsok="2">
            <dl class="list-none navnow">
                <dt id='part2_4'><a href='#' title='社团活动' class="zm"><span>社团活动</span></a></dt>
            </dl>
            <div class="clear"></div>
        </div>
